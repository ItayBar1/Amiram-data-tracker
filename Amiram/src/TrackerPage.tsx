...
const TrackerPage: React.FC<TrackerPageProps> = ({ session }) => {
  ...
  const stats = useMemo(() => {
    ...
    const last3Avg =
      last3.length > 0
        ? last3.reduce((sum, item) => sum + Number(item.score), 0) / last3.length
        : 0;
    return {
      maxScore,
      avgScore,
    ...
    <div className="min-h-screen bg-[#f3f4f6] font-sans text-right" dir="rtl">
      ...
      <main className="max-w-7xl mx-auto px-4 -mt-12 relative z-20 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <StatCard title="ימי תרגול" value={stats?.count || 0} icon={Calendar} />
          <StatCard title="מבחן אחרון" value={stats?.lastScore || "-"} icon={History} />
          <StatCard
            title="ציון שיא"
              ...
              <div className="h-[350px] w-full" dir="ltr">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <ReferenceArea y1={134} y2={150} fill="#dcfce7" fillOpacity={0.4} strokeOpacity={0} />
                    <ReferenceArea y1={120} y2={134} fill="#fef9c3" fillOpacity={0.4} strokeOpacity={0} />
                    <ReferenceArea y1={100} y2={120} fill="#ffedd5" fillOpacity={0.4} strokeOpacity={0} />
                    <ReferenceArea y1={85} y2={100} fill="#fee2e2" fillOpacity={0.4} strokeOpacity={0} />
                    <ReferenceArea y1={50} y2={85} fill="#f3f4f6" fillOpacity={0.4} strokeOpacity={0} />
